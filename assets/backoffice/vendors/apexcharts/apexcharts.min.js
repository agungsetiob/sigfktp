...
!function(t, e) {
    ...
    var u = function() {
      ...
      , g = function() {
        ...
        return s(t, [{
            ...
            value: function(t, e) {
                ...
                t.filter(function(t) {
                    var e = null;
                    e = u.isSafari() || u.isFirefox() || u.isIE() ? t.flood(r, o).composite(t.sourceAlpha, "in").offset(a, s).gaussianBlur(n) : t.flood(r, o).composite(t.sourceAlpha, "in").offset(a, s).gaussianBlur(n).merge(t.source),
                    t.blend(t.source, e)
                }),
      ...
      , f = function() {
        ...
        return s(t, [{
            ...
            value: function() {
                ...
                "function" == typeof t.config.chart.events.animationEnd && t.config.chart.events.animationEnd(this.ctx, t)
            }
        }, {
            key: "morphSVG",
            value: function(t, e, i, s, a, n, r) {
                ...
                t.plot(i).animate(1, l.globals.easing, r).plot(i).animate(a, l.globals.easing, r).plot(s).afterAll(function() {
                    u.isNumber(e) ? e === l.globals.series[l.globals.maxValsInArrayIndex].length - 2 && l.globals.shouldAnimate && o.animationCompleted() : l.globals.shouldAnimate && o.animationCompleted(),
      ...
      , p = function() {
        ...
        return s(t, [{
            ...
            key: "drawText",
            value: function(t) {
                var e, i = this.w, s = t.x, a = t.y, n = t.text, r = t.textAnchor, o = t.fontSize, l = t.fontFamily, h = t.fontWeight, c = t.foreColor, d = t.opacity;
                return void 0 === n && (n = ""),
                r || (r = "start"),
            ...
            value: function(t, e, i) {
                ...
                if ("square" === i.shape) {
                    ...
                    "circle" !== i.shape && i.shape || (u.isNumber(e) || (s = 0,
                    e = 0),
                    a = this.drawCircle(s, {
                        cx: t,
                        cy: e,
    ...
    var x = {
      ...
      , m = function() {
        ...
        return s(t, [{
            ...
            value: function(t, e, i) {
                ...
                if (!(r < 0 || r > s.globals.gridWidth)) {
                    if (null === t.x2) {
                        ...
                        if ("category" !== s.config.xaxis.type && !s.config.xaxis.convertedCatToNumeric || this.invertAxis || s.globals.isXNumeric || (c = this.getStringX(t.x2)),
                        c < r) {
                            var d = r;
                            r = c,
                            c = d
            ...
            value: function(t) {
                ...
                (e = u.listToArray(e)).forEach(function(t) {
                    for (; t.firstChild; )
        ...
        return s(t, [{
            ...
            value: function(t, e) {
                var i = !(arguments.length > 2 && void 0 !== arguments[2]) || arguments[2]
                  ...
                  , n = ["\0"].concat(d(a.months))
                  , r = ["\x01"].concat(d(a.shortMonths))
                  , o = ["\x02"].concat(d(a.days))
                  , l = ["\x03"].concat(d(a.shortDays));
                function h(t, e) {
                    var i = t + "";
      ...
      , C = function() {
        ...
        return s(t, [{
            ...
            value: function(t) {
                ...
                i = "url(#pattern".concat(e.globals.cuid).concat(t.seriesNumber + 1, ")")) : i = h : i = "gradient" === o ? a : "pattern" === o ? s : h,
                t.solid && (i = h),
                i
            }
        }, {
            ...
            value: function(t, e, i, s) {
                ...
                return l.drawGradient(c, a, n, d, g, o.size, r.fill.gradient.stops, r.fill.gradient.colorStops, s)
            }
        }]),
        t
    }()
      , L = function() {
        ...
        return s(t, [{
            ...
            value: function(t, e, i) {
                var s, a = this.w, n = e, r = t, o = null, l = new p(this.ctx);
                ...
                r.x instanceof Array)
                    for (var h = 0; h < r.x.length; h++) {
                        ...
                        if ("line" !== a.config.chart.type && "area" !== a.config.chart.type || a.globals.comboCharts || a.config.tooltip.intersect || (d += " no-pointer-events"),
                        Array.isArray(a.config.markers.size) ? a.globals.markers.size[e] > 0 : a.config.markers.size > 0) {
                            u.isNumber(r.y[h]) ? d += " w".concat((Math.random() + 1).toString(36).substring(4)) : d = "apexcharts-nullpoint";
                            var f = this.getMarkerConfig(d, e, c);
                            a.config.series[n].data[i] && (a.config.series[n].data[i].fillColor && (f.pointFillColor = a.config.series[n].data[i].fillColor),
                            a.config.series[n].data[i].strokeColor && (f.pointStrokeColor = a.config.series[n].data[i].strokeColor)),
                            (s = l.drawMarker(r.x[h], r.y[h], f)).attr("rel", c),
                            s.attr("j", c),
                            s.attr("index", e),
                            s.node.setAttribute("default-marker-size", f.pSize),
                            new g(this.ctx).setSelectionFilter(s, e, c),
                            this.addEvents(s),
                            o && o.add(s)
                        } else
                            void 0 === a.globals.pointsArray[e] && (a.globals.pointsArray[e] = []),
                            a.globals.pointsArray[e].push([r.x[h], r.y[h]])
                    }
                return o
            }
        }, {
            ...
            value: function(t, e) {
                ...
                null !== i && r.discrete.length && r.discrete.map(function(t) {
                    t.seriesIndex === e && t.dataPointIndex === i && (a.pointStrokeColor = t.strokeColor,
                    a.pointFillColor = t.fillColor,
                    n = t.size)
                });
                var o = "bubble" === s.config.chart.type ? s.config.stroke.width : r.strokeWidth;
                return {
                    pSize: n,
                    pRadius: r.radius,
            ...
            value: function(t, e, i) {
                ...
                r.x instanceof Array)
                    for (var c = 0; c < r.x.length; c++) {
                        ...
                        o !== 1 / 0 && (f = s.globals.seriesZ[n][d] / o,
                        void 0 === this.radiusSizes[n] && this.radiusSizes.push([]),
                        this.radiusSizes[n].push(f)),
                        ...
                        u) {
                            var m = this.drawPoint(x, b, g, f, n, d, e);
                            h.add(m)
                        }
                        l.add(h)
                    }
            ...
            value: function(t, e, i, s, a, n, r) {
                ...
                if (o.globals.dataChanged)
                    if (this.dynamicAnim) {
                        ...
                        null != (P = o.globals.previousPaths[a] && o.globals.previousPaths[a][r]) && (k = P.x,
                        A = P.y,
                        S = void 0 !== P.r ? P.r : s);
                        for (var M = 0; M < o.globals.collapsedSeries.length; M++)
                            o.globals.collapsedSeries[M].index === a && (z = 1,
                            s = 0);
                        0 === t && 0 === e && (s = 0),
                        h.animateCircle(v, {
                            cx: k,
        ...
        return s(t, [{
                ...
                for (var d = 0; d < t.x.length; d++)
                    ...
                    !isNaN(o)) {
                        ...
                        if ("bubble" === a.config.chart.type)
                            ...
                            void 0 !== u && (g = a.config.dataLabels.formatter(u, {
                                ctx: this.ctx,
                                seriesIndex: e,
                                dataPointIndex: h,
                                w: a
            ...
            value: function(t) {
                ...
                if (!(Array.isArray(e.config.dataLabels.enabledOnSeries) && e.config.dataLabels.enabledOnSeries.indexOf(n) < 0)) {
                    ...
                    if (u && (f = this.dataLabelsCorrection(s, a, o, n, r, d, parseInt(c.style.fontSize))),
                    e.globals.zoomed || (s = f.x,
                    a = f.y),
                    f.textRects && (s + f.textRects.width < 10 || s > e.globals.gridWidth + 10) && (o = ""),
                    f.drawnextLabel) {
                        var x = i.drawText({
                            width: 100,
      ...
      , M = function() {
        ...
        return s(t, [{
            ...
            value: function(t, e) {
                ...
                o++) {
                    var l, h, c, d, g = void 0, f = void 0, x = void 0, b = void 0, m = [], v = [], y = i.globals.comboCharts ? e[r] : r, k = s.group({
                    ...
                    M--) {
                        ...
                        C = this.series[r][z] / this.invertedYRatio) : (E = this.drawColumnPaths({
                            indexes: {
                                i: r,
                                j: z,
                                realIndex: y,
            ...
            value: function(t) {
                ...
                new g(this.ctx).setSelectionFilter(A, e, a),
                h.add(A);
            ...
            value: function() {
                ...
                l.globals.isXNumeric && (l.globals.minXDiff && (s = l.globals.minXDiff / this.xRatio),
                (n = s / this.seriesLen * parseInt(this.barOptions.columnWidth) / 100) < 1 && (n = 1)),
            ...
            value: function(t, e) {
                for (var i, s = this.w, a = 0; a < s.globals.previousPaths.length; a++) {
                    ...
                    n.paths && n.paths.length > 0 && parseInt(n.realIndex) === parseInt(t) && void 0 !== s.globals.previousPaths[a].paths[e] && (i = s.globals.previousPaths[a].paths[e].d)
                }
                return i
            }
        }, {
            ...
            value: function(t) {
                ...
                if (c.enabled && !b) {
                    ...
                    d.config.chart.stacked && this.barOptions.dataLabels.hideOverflowingLabels && (this.isHorizontal ? ((h = this.series[a][n] / this.yRatio[this.yaxisIndex]) > 0 && o.width / 1.6 > h || h < 0 && o.width / 1.6 < h) && (m = "") : (l = this.series[a][n] / this.yRatio[this.yaxisIndex],
                    o.height / 1.6 > l && (m = "")));
                    var v = r({}, c);
                    ...
                    u.plotDataLabelsText({
                        ...
                        y: i,
                        text: m,
                        i: this.barOptions.distributed ? n : a,
                        j: n,
                        parent: x,
                        dataLabelsConfig: v,
      ...
      , E = function(t) {
        ...
        s(i, [{
            ...
            value: function(t, e) {
                ...
                this.bar = new M(this.ctx,this.xyRatios);
                var s = new w(this.ctx,i);
                t = s.getLogSeries(t),
                ...
                h++) {
                    ...
                    for (var E = 0; E < i.globals.dataPoints; E++) {
                        ...
                        P = this.series[l][E] / this.invertedYRatio) : (T = this.drawColumnPaths({
                            indexes: {
                                i: l,
                                j: E,
                                realIndex: y,
      ...
      , T = function(t) {
        ...
        s(i, [{
            ...
            value: function(t, e) {
                ...
                l++) {
                    var h, c, d = void 0, g = void 0, f = void 0, x = void 0, b = [], m = [], v = i.globals.comboCharts ? e[o] : o, y = s.group({
                        class: "apexcharts-series",
                ...
                for (var h = o ? 0 : l.length - 1; o ? h < l.length : h >= 0; o ? h++ : h--) {
                    ...
                    for (var f = 0, x = 0; x < l[h].length; x++) {
                        ...
                        e.config.chart.animations.enabled && !e.globals.dataChanged) {
                            ...
                            this.animateHeatMap(A, f, r, a, n, S)
                        }
            ...
            value: function(t) {
                ...
                if (l.enabled) {
                    ...
                    var g = l.offsetX
                      , f = l.offsetY
                      , x = e + r / 2 + g
                      , b = i + n / 2 + parseInt(l.style.fontSize) / 3 + f
        ...
        return s(t, [{
            ...
            value: function(t) {
                ...
                for (var l = 0; l < t.length; l++) {
                    var h = this.fullAngle * u.negToZero(t[l]) / a;
                    r.push(h)
                }
                if (e.globals.dataChanged) {
            ...
            key: "pieClicked",
            value: function(t) {
                var e, i = this.w, s = this.w.globals.radialSize + 4, a = i.globals.dom.Paper.select(".apexcharts-".concat(i.config.chart.type.toLowerCase(), "-slice-").concat(t)).members[0], n = a.attr("d");
            ...
            value: function(t) {
                ...
                var h = Math.PI * (l - 90) / 180
                  ...
                  , b = s > 180 ? 1 : 0;
                return "donut" === n.config.chart.type ? ["M", c, d, "A", a, a, 0, b, 1, g, f, "L", p.x, p.y, "A", e.donutSize, e.donutSize, 0, b, 0, x.x, x.y, "L", c, d, "z"].join(" ") : "pie" === n.config.chart.type ? ["M", c, d, "A", a, a, 0, b, 1, g, f, "L", e.centerX, e.centerY, "L", c, d].join(" ") : ["M", c, d, "A", a, a, 0, b, 1, g, f].join(" ")
            }
        }, {
        ...
        return s(t, [{
            ...
            value: function(t) {
                ...
                t.forEach(function(t, n) {
                    ...
                    t.forEach(function(t, i) {
                        var s = new L(e.ctx).getMarkerConfig("apexcharts-marker", n, i)
      ...
      , R = function(t) {
        function i(t) {
            var s;
            e(this, i),
            (s = c(this, l(i).call(this, t))).ctx = t,
            s.w = t.w,
            s.animBeginArr = [0],
            s.animDur = 0;
            var a = s.w;
      ...
      , D = function(t) {
        ...
        s(i, [{
            ...
            value: function(t, e) {
                ...
                o++) {
                    var l, h, c, d, g = void 0, f = void 0, x = void 0, b = void 0, m = i.globals.comboCharts ? e[r] : r, v = s.group({
                        class: "apexcharts-series",
            ...
            value: function(t) {
                ...
                var b = Math.abs(f - g);
                return a = h.move(g, x) + h.line(f, x) + h.line(f, x + r) + h.line(g, x + r) + h.line(g, x),
        ...
        return s(t, [{
            ...
            value: function(t, e, i) {
                ...
                if ("datetime" === s.config.xaxis.type && (void 0 === s.config.xaxis.labels.formatter && void 0 === s.config.tooltip.x.formatter))
                    return new v(this.ctx).formatDate(new Date(e), s.config.tooltip.x.format, !0, !0);
                return t(e, i)
            }
        }, {
            ...
            value: function() {
                ...
                t.config.yaxis.forEach(function(e, i) {
                    void 0 !== e.labels.formatter ? t.globals.yLabelFormatters[i] = e.labels.formatter : t.globals.yLabelFormatters[i] = function(s) {
                        return t.globals.xyCharts && u.isNumber(s) ? 0 !== t.globals.yValueDecimal ? s.toFixed(void 0 !== e.decimalsInFloat ? e.decimalsInFloat : t.globals.yValueDecimal) : t.globals.maxYArr[i] - t.globals.minYArr[i] < 10 ? s.toFixed(1) : s.toFixed(0) : s
                    }
                }),
                t.globals
            }
      ...
      , O = function() {
        ...
        return s(t, [{
            key: "getLabel",
            value: function(t, e, i, s) {
                var a, n = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : [], r = this.w, o = void 0 === t[s] ? "" : t[s], l = r.globals.xLabelFormatter, h = r.config.xaxis.labels.formatter, c = !1, d = o;
                a = new N(this.ctx).xLabelFormat(l, o, d),
                void 0 !== h && (a = h(o, t[s], s));
                var u, g;
                return e.length > 0 ? (u = e[s].unit,
                g = null,
      ...
      , W = function() {
        ...
        return s(t, [{
            ...
            value: function(t) {
                ...
                new H(this.ctx).setYAxisXPosition(s, n)
            }
        }, {
            ...
            value: function() {
                ...
                return 1.05 * (t = new p(this.ctx).getTextRects(s, e.config.xaxis.labels.style.fontSize)).width * i.length > e.globals.gridWidth && 0 !== e.config.xaxis.labels.rotate && (e.globals.overlappingXLabels = !0),
                t
            }
        }, {
            ...
            value: function() {
                ...
                if (e.globals.timelineLabels.length > 0) {
                    ...
                    var o = r;
                    r = new N(this.ctx).xLabelFormat(n, r, o);
            ...
            value: function() {
                ...
                return e.config.yaxis.map(function(a, n) {
                    if (a.show && a.labels.show && e.globals.yAxisScale[n].result.length) {
                        ...
                        var l = new p(t.ctx).getTextRects(o, a.labels.style.fontSize);
                        i.push({
                            width: l.width + s,
                            height: l.height
                        })
            ...
            value: function() {
                ...
                if (void 0 !== t.config.xaxis.title.text) {
                    var s = new p(this.ctx).getTextRects(t.config.xaxis.title.text, t.config.xaxis.title.style.fontSize);
                    e = s.width,
                    i = s.height
                }
                return {
            ...
            value: function() {
                ...
                return e.config.yaxis.map(function(e, s) {
                    if (e.show && void 0 !== e.title.text) {
                        var a = new p(t.ctx).getTextRects(e.title.text, e.title.style.fontSize, e.title.style.fontFamily, "rotate(-90 0 0)", !1);
                        i.push({
                            width: a.width,
                            height: a.height
                        })
        ...
        return s(t, [{
            ...
            value: function() {
                ...
                if ((i.legend.showForSingleSeries && 1 === e.series.length || e.series.length > 1 || !e.axisCharts) && i.legend.show) {
                    ...
                    this.drawLegends(),
                    u.isIE11() || this.appendToForeignObject(),
        ...
        return s(t, [{
            ...
            value: function(t, e, i) {
                ...
                for (var d = this.xyRatios.zRatio, g = this.xyRatios.xRatio, f = this.xyRatios.baseLineY, x = [], b = [], m = 0, v = 0; v < t.length; v++) {
                    ...
                    var S = []
                      , P = []
                      , M = s.globals.gridHeight - f[this.yaxisIndex] - (this.isReversed ? s.globals.gridHeight : 0) + (this.isReversed ? 2 * f[this.yaxisIndex] : 0)
                      , E = M;
                    M > s.globals.gridHeight && (E = s.globals.gridHeight),
                    m = k / 2;
                    ...
                    var X = void 0
                      ...
                      , O = a.group({
                        class: "apexcharts-series",
                        seriesName: u.escapeString(s.globals.seriesNames[A])
                    })
                      , H = a.group({
                    ...
                    null === t[v][0]) {
                        ...
                        X = a.move(_, j),
                        Y = a.move(_, E) + a.line(_, j);
                    if (F = a.move(-1, M) + a.line(-1, M),
                    ...
                    for (var $ = s.globals.dataPoints > 1 ? s.globals.dataPoints - 1 : s.globals.dataPoints, J = 0; J < $; J++) {
                        if (s.globals.isXNumeric) {
                            ...
                            T += k;
                        var K = u.isNumber(s.globals.minYArr[A]) ? s.globals.minYArr[A] : s.globals.minY;
                        s.config.chart.stacked ? (U = v > 0 && s.globals.collapsedSeries.length < s.config.series.length - 1 ? b[v - 1][J + 1] : M,
                        I = void 0 === t[v][J + 1] || null === t[v][J + 1] ? U - K / c[this.yaxisIndex] + 2 * (this.isReversed ? K / c[this.yaxisIndex] : 0) : U - t[v][J + 1] / c[this.yaxisIndex] + 2 * (this.isReversed ? t[v][J + 1] / c[this.yaxisIndex] : 0)) : I = void 0 === t[v][J + 1] || null === t[v][J + 1] ? M - K / c[this.yaxisIndex] + 2 * (this.isReversed ? K / c[this.yaxisIndex] : 0) : M - t[v][J + 1] / c[this.yaxisIndex] + 2 * (this.isReversed ? t[v][J + 1] / c[this.yaxisIndex] : 0),
                        P.push(T),
                        S.push(I);
                        ...
                        Y = tt.areaPath,
                        X = tt.linePath,
                        this.appendPathFrom && (F += a.line(T, M),
                        R += a.line(T, M));
            ...
            value: function(t) {
                ...
                if (0 === r) {
                    ...
                    g.push(u.isNumber(e[n][r + 1]) ? a + c.config.markers.offsetY : null)
                } else
                    d.push(s + c.config.markers.offsetX),
                    g.push(u.isNumber(e[n][r + 1]) ? a + c.config.markers.offsetY : null);
                return {
      ...
      , _ = function() {
        ...
        return s(t, [{
            key: "drawXaxis",
            value: function() {
                var t, e = this.w, i = new p(this.ctx), s = i.group({
            ...
            value: function(t) {
                var e, i, s = this.w, a = new p(this.ctx), n = s.config.yaxis[0].opposite ? s.globals.translateYAxisX[t] : 0, r = a.group({
                ...
                if (d.show)
                    for (var u = 0; u <= l.length - 1; u++) {
                        ...
                        0 !== s.config.yaxis[t].labels.rotate) {
                            var x = a.rotateAroundCenter(f.node);
                            f.node.setAttribute("transform", "rotate(".concat(s.config.yaxis[t].labels.rotate, " ").concat(x.x, " ").concat(x.y, ")"))
                        }
                        i += e
                    }
            ...
            value: function(t, e) {
                ...
                if (!(t < 0 || t > i.globals.gridWidth)) {
                    ...
                    if (i.config.xaxis.axisTicks.show) {
                        var r = new p(this.ctx).drawLine(t + i.config.xaxis.axisTicks.offsetX, a + i.config.xaxis.offsetY, s + i.config.xaxis.axisTicks.offsetX, n + i.config.xaxis.offsetY, i.config.xaxis.axisTicks.color);
                        e.add(r),
            ...
            value: function() {
                ...
                if (a.length > 0) {
                    ...
                    for (var f = 0; f < n.length; f++)
                        e.placeTextWithEllipsis(n[f], n[f].textContent, t.config.yaxis[0].labels.maxWidth - 2 * parseInt(t.config.yaxis[0].title.style.fontSize) - 20)
                }
            }
        }]),
        t
      ...
      , j = function() {
        ...
        return s(t, [{
            ...
            value: function(t, e, i) {
                ...
                var v = t;
                (o = []).push(v);
                for (var y = Math.abs(e - t) / a, w = 0; w <= a; w++)
                    v += y,
                    o.push(v);
            ...
            value: function(t, e, i) {
                ...
                if (void 0 === s.yAxisScale[t] && (s.yAxisScale[t] = []),
                n.logarithmic)
                    s.allSeriesCollapsed = !1,
                    s.yAxisScale[t] = this.logarithmicScale(t, e, i, n.tickAmount ? n.tickAmount : Math.floor(Math.log10(i)));
                else if (i !== -Number.MAX_VALUE && u.isNumber(i))
                    if (s.allSeriesCollapsed = !1,
            ...
            value: function(t, e, i) {
                ...
                return e.forEach(function(t, r) {
                    ...
                    var h, c, d = s.globals.minYArr[r], u = s.globals.maxYArr[r], g = s.globals.stackedSeriesTotals;
                    s.globals.series.forEach(function(r, l) {
                        var f = r[o];
                        n ? (f = g[o],
                        h = c = f,
                        g.forEach(function(t, e) {
                            a[e] <= i.xaxis.max && a[e] >= i.xaxis.min && (t > c && null !== t && (c = t),
            ...
            value: function(t) {
                ...
                for (var c = t; c < s; c++) {
                    ...
                    for (var d = 0; d < a.series[c].length; d++) {
                        ...
                        e = Math.min(e, l[c][d]),
                        i = Math.max(i, l[c][d]),
                        "candlestick" === this.w.config.chart.type && (n = Math.max(n, a.seriesCandleO[c][d]),
                        ...
                        r > l[c][d] && l[c][d] < 0 && (r = l[c][d])) : a.hasNullValues = !0
                    }
                }
                return {
                    minY: r,
                    ...
                    for (var a = 0; a < e.series.length; a++)
                        if (e.labels[a])
                            for (var n = 0; n < e.labels[a].length; n++)
                                null !== e.labels[a][n] && u.isNumber(e.labels[a][n]) && (e.maxX = Math.max(e.maxX, e.labels[a][n]),
      ...
      , q = function() {
        ...
        return s(t, [{
            ...
            value: function(t, e) {
                ...
                n < .005 ? s.globals.disableZoomIn = !0 : n > 5e4 && (s.globals.disableZoomOut = !0);
                var o = a.getTimeUnitsfromTimestamp(t, e)
                  , l = s.globals.gridWidth / n
                  , h = l / 24
                  , c = h / 60
                  , d = Math.floor(24 * n)
            ...
            value: function(t) {
                ...
                for (var c = r, d = o, g = 0; g < n; g++)
                    c++,
                    d = l.determineDaysOfYear(c - 1) * a + d,
                    this.timeScaleArray.push({
                        position: d,
                        value: c,
                        unit: "year",
        ...
        return s(t, [{
            ...
            value: function(t, e) {
                ...
                a.series.map(function(e, s) {
                    ...
                    l.series.push(e),
                    l.i.push(s),
                    i.globals.columnSeries = l.series) : "area" === t[s].type ? (r.series.push(e),
                ...
                if (a.comboCharts) {
                    ...
                    case "bar":
                        ...
                        break;
                    case "candlestick":
                        x = new T(this.ctx,e).draw(a.series);
                        break;
                    case "rangeBar":
                        x = f.draw(a.series);
                        break;
            ...
            value: function() {
                ...
                if ("%" === s ? u.isNumber(i[0]) && (0 === i[0].width && (i = u.getDimensions(this.el.parentNode)),
                ...
                "auto" !== t.svgHeight && "" !== t.svgHeight)
                    if ("%" === e.chart.height.toString().split(/[0-9]+/g).pop()) {
                        var a = u.getDimensions(this.el.parentNode);
            ...
            value: function() {
                ...
                var s = t.globals.dom.baseEl.querySelector(".apexcharts-radialbar .apexcharts-tracks")
                  , a = t.globals.dom.baseEl.querySelector(".apexcharts-radialbar .apexcharts-datalabels-group")
                  , n = 2 * t.globals.radialSize;
                if (s) {
                    var r = u.getBoundingClientRect(s);
                    if (n = r.bottom,
                    a) {
                        var o = u.getBoundingClientRect(a)
            ...
            value: function(t, e) {
                for (var i = this.w.config, s = this.w.globals, a = 0; a < t[e].data.length; a++)
                    if (void 0 !== t[e].data[a][1] && (Array.isArray(t[e].data[a][1]) && 4 === t[e].data[a][1].length ? this.twoDSeries.push(u.parseNumber(t[e].data[a][1][3])) : this.twoDSeries.push(u.parseNumber(t[e].data[a][1])),
            ...
            value: function(t) {
                for (var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : this.ctx, i = this.w.config, s = this.w.globals, a = new v(e), n = 0; n < t.length; n++) {
                    if (this.twoDSeries = [],
                    this.twoDSeriesX = [],
                    this.threeDSeries = [],
                    void 0 === t[n].data)
            ...
            key: "drawAxis",
            value: function(t, e) {
                var i, s, a = this.w.globals, n = this.w.config, r = new _(this.ctx), o = new H(this.ctx);
                    ...
                    e.config.chart.events.selection = function(t, s) {
                        i.forEach(function(t) {
                            var i = ApexCharts.getChartByID(t)
                              , a = u.clone(e.config.yaxis);
                            e.config.chart.brush.autoScaleYaxis && (a = new j(i).autoScaleY(i, a, s));
                            i._updateOptions({
                                xaxis: {
                                    min: s.xaxis.min,
                                    max: s.xaxis.max
    ...
    var nt, rt, ot = function() {
        ...
        return s(t, [{
            ...
            value: function() {
                ...
                return new Q(function(e) {
                    ...
                    s.height = parseInt(i.globals.dom.elWrap.style.height);
        ...
        return s(t, [{
                ...
                if (t.globals.isBarHorizontal) {
                    ...
                    t.config.grid.xaxis.lines.show || t.config.xaxis.axisTicks.show)
                        ...
                        u !== r - 1); u++) {
                            ...
                            new _(this.ctx).drawXaxisTicks(c, s)
                        }
                    ...
                    t.config.grid.xaxis.lines.show || t.config.xaxis.axisTicks.show) {
                        ...
                        if (t.globals.timelineLabels.length > 0)
                            ...
                            for (var L = r, P = 0; P < L; P++) {
                                var z = L;
                                if (t.globals.isXNumeric && "bar" !== t.config.chart.type && (z -= 1),
                                ...
                                new _(this.ctx).drawXaxisTicks(w, s)
                            }
                    }
                    if (t.config.grid.yaxis.lines.show)
                        for (var E = 0, T = 0, I = t.globals.gridWidth, X = 0; X < o + 1; X++) {
                            var Y = e.drawLine(0, E, I, T, t.config.grid.borderColor, i);
                            a.add(Y),
            ...
            value: function(t, e, i) {
                ...
                if (void 0 !== s.config.grid.column.colors && s.config.grid.column.colors.length > 0)
                    for (var u = s.globals.padHorizontal, g = s.globals.padHorizontal + s.globals.gridWidth / e, f = s.globals.gridHeight, x = 0, b = 0; x < e; x++,
                    b++) {
                        b >= s.config.grid.column.colors.length && (b = 0);
                        var m = s.config.grid.column.colors[b]
                          , v = a.drawRect(u, 0, g, f, 0, m, s.config.grid.column.opacity);
                      ...
                      , r = function() {
                        ...
                        if (r > s) {
                            ...
                            for (var l = 0; l < a.length; l++)
                                r < a[l].breakpoint && (t = w.extendArrayProps(n, a[l].options),
                                t = u.extend(i.config, t),
                                e.overrideResponsiveOptions(t))
                    };
                    if (t) {
        ...
        return s(t, [{
            ...
            value: function(t) {
                for (var e = 0, i = new w(this.ctx), s = t.map(function(t, e) {
        ...
        return s(t, [{
            ...
            value: function(t) {
                var e = t.i
                  ...
                  , f = null;
                f = s[i].children,
                l.config.tooltip.fillSeriesColor && (s[i].style.backgroundColor = o,
                ...
                var p = s[i].querySelector(".apexcharts-tooltip-text-label");
                p && (p.innerHTML = n ? n + ": " : "");
                var x = s[i].querySelector(".apexcharts-tooltip-text-value");
                (x && (x.innerHTML = c),
                ...
                null !== g) && (s[i].querySelector(".apexcharts-tooltip-text-z-label").innerHTML = l.config.tooltip.z.title,
                s[i].querySelector(".apexcharts-tooltip-text-z-value").innerHTML = g);
            ...
            value: function(t) {
                ...
                var c = n;
                s.globals.isXNumeric && "datetime" === s.config.xaxis.type ? n = new N(this.ctx).xLabelFormat(s.globals.ttKeyFormatter, c, c) : s.globals.isBarHorizontal || (n = s.globals.xLabelFormatter(c, l));
        ...
        return s(t, [{
            ...
            value: function(t) {
                ...
                if (null !== i.xaxisTooltip) {
                    ...
                    !isNaN(t)) {
                        ...
                        var a;
                        a = new p(this.ctx).getTextRects(i.xaxisTooltipText.innerHTML),
            ...
            value: function(t, e) {
                ...
                if (void 0 === o && (o = a.globals.markers.size[e] + a.config.markers.hover.sizeOffset),
                !a.config.series[e].type || "column" !== a.config.series[e].type) {
                    i = r[e][t][0],
                    s = r[e][t][1] ? r[e][t][1] : 0;
            ...
            value: function(t) {
                var e, i = this.w, s = this.ttCtx, a = i.globals.columnSeries ? i.globals.columnSeries.length : i.globals.series.length, n = a >= 2 && a % 2 == 0 ? Math.floor(a / 2) : Math.floor(a / 2) + 1, r = i.globals.dom.baseEl.querySelector(".apexcharts-bar-series .apexcharts-series[rel='".concat(n, "'] path[j='").concat(t, "'], .apexcharts-candlestick-series .apexcharts-series[rel='").concat(n, "'] path[j='").concat(t, "'], .apexcharts-rangebar-series .apexcharts-series[rel='").concat(n, "'] path[j='").concat(t, "']")), o = r ? parseFloat(r.getAttribute("cx")) : 0, l = r ? parseFloat(r.getAttribute("barWidth")) : 0;
                i.globals.isXNumeric ? o -= a % 2 != 0 ? l / 2 : 0 : (o = s.xAxisTicksPositions[t - 1] + s.dataPointsDividedWidth / 2,
                isNaN(o) && (o = s.xAxisTicksPositions[t] - s.dataPointsDividedWidth / 2));
                var h = s.getElGrid().getBoundingClientRect();
                if (e = s.e.clientY - h.top - s.tooltipRect.ttHeight / 2,
        ...
        return s(t, [{
            ...
            value: function() {
                for (var t = this.w, e = new p(this.ctx), i = new L(this.ctx), s = t.globals.dom.baseEl.querySelectorAll(".apexcharts-series"), a = 0; a < s.length; a++) {
        ...
        return s(t, [{
            ...
            value: function(t) {
                ...
                if (s.target.classList.contains("apexcharts-marker")) {
                    ...
                    l.intersect) {
                        var g = u.findAncestor(a.paths, "apexcharts-series");
        ...
        return s(t, [{
            ...
            value: function(t) {
                ...
                e.globals.collapsedSeries.length !== e.globals.series.length) {
                    ...
                    (e.globals.xyCharts || e.globals.comboCharts) && this.tConfig.shared && (a = this.showOnIntersect ? 1 : e.globals.series.length),
            ...
            value: function(t) {
                for (var e = this.w, i = [], s = this.getElTooltip(), a = 0; a < t; a++) {
                    ...
                    this.tConfig.shared && this.tConfig.enabledOnSeries && Array.isArray(this.tConfig.enabledOnSeries) && this.tConfig.enabledOnSeries.indexOf(a) < 0 && n.classList.add("apexcharts-tooltip-series-group-hidden");
            ...
            value: function() {
                ...
                if (t.globals.xyCharts && !this.showOnIntersect || t.globals.comboCharts && !this.showOnIntersect || s && this.hasBars() && this.tConfig.shared)
            ...
            value: function() {
                ...
                return this.tConfig.fixed.position.toLowerCase().indexOf("right") > -1 && (n = n + t.globals.svgWidth - s + 10),
            ...
            value: function(t) {
                ...
                i.e = a,
                !i.hasBars() || n.globals.comboCharts || i.isBarShared) || this.tConfig.onDatasetHover.highlightDataSeries && new B(e).toggleSeriesOnHover(a, a.target.parentNode);
            ...
            value: function() {
                for (var t = this.w, e = new p(this.ctx), i = t.globals.dom.Paper.select(".apexcharts-bar-area"), s = 0; s < i.length; s++)
        ...
        return s(t, [{
            ...
            value: function() {
                ...
                s.forEach(function(t, e) {
                    t.index && u.moveIndexInArray(s, e, t.index)
                });
        ...
        s(i, [{
            ...
            value: function(t) {
                var e = t.context
                  ...
                  , d = 0
                  , u = {};
                return Math.abs(l + r) > s.globals.gridWidth ? l = s.globals.gridWidth - r : a.clientX - n.left < 0 && (l = r),
            ...
            value: function(t) {
                ...
                if (s.config.yaxis.forEach(function(t, e) {
                    d.push(Math.floor(s.globals.yAxisScale[e].niceMax - n.yRatio[e] * a.startY)),
                ...
                a.dragged && (a.dragX > 10 || a.dragY > 10) && h !== c)
                    if (s.globals.zoomEnabled) {
                        var f = u.clone(s.globals.initialConfig.yaxis);
                        s.globals.zoomed || (s.globals.lastXAxis = u.clone(s.config.xaxis),
                        s.globals.lastYAxis = u.clone(s.config.yaxis));
                        var p = {
                            min: h,
                            max: c
                        };
                        ...
                        "xy" !== i && "y" !== i || (y = u.clone(s.config.yaxis)).forEach(function(t, e) {
                            y[e].min = g[e],
                            y[e].max = d[e]
                        }),
            ...
            key: "panDragging",
            value: function(t) {
                var e, i = t.context, s = this.w, a = i;
            ...
            value: function(t, e, i) {
                var s = this.w
                  , a = this.xyRatios
                  , n = u.clone(s.globals.initialConfig.yaxis);
                ...
                s.config.chart.zoom.autoScaleYaxis && (n = new j(this.ctx).autoScaleY(this.ctx, n, {
                    xaxis: r
                }));
                var o = {
                    xaxis: {
                ...
                s.config.chart.group || (o.yaxis = n),
    ...
    function() {
        ...
        function s(t) {
            ...
            case "A":
                t = (e = function(t, e) {
                    var i, s, a, n, r, o, l, h, c, d, u, g, f, p, x, b, m, v, y, w, k, A, S, C, L, P, z = Math.abs(e[1]), M = Math.abs(e[2]), E = e[3] % 360, T = e[4], I = e[5], X = e[6], Y = e[7], F = new SVG.Point(t), R = new SVG.Point(X,Y), D = [];
                    if (0 === z || 0 === M || F.x === R.x && F.y === R.y)
                        return [["C", F.x, F.y, R.x, R.y, R.x, R.y]];
                    i = new SVG.Point((F.x - R.x) / 2,(F.y - R.y) / 2).transform((new SVG.Matrix).rotate(E)),
                    (s = i.x * i.x / (z * z) + i.y * i.y / (M * M)) > 1 && (s = Math.sqrt(s),
                    z *= s,
                    M *= s);
                    a = (new SVG.Matrix).rotate(E).scale(1 / z, 1 / M).rotate(-E),
                    F = F.transform(a),
                    R = R.transform(a),
                    n = [R.x - F.x, R.y - F.y],
                    o = n[0] * n[0] + n[1] * n[1],
                    ...
                    a = (new SVG.Matrix).rotate(E).scale(z, M).rotate(-E),
                    k = 0,
                    A = b.length; k < A; k++)
    ...
    function() {
        ...
        t.prototype.drag = function(t) {
            ...
            if ("function" == typeof n) {
                ...
                "object" == typeof n && (null != n.minX && s < n.minX ? r = (s = n.minX) - this.startPoints.box.x : null != n.maxX && s > n.maxX - e.width && (r = (s = n.maxX - e.width) - this.startPoints.box.x),
                ...
                null != n.snapToGrid && (s -= s % n.snapToGrid,
                a -= a % n.snapToGrid,
                r -= r % n.snapToGrid,
                o -= o % n.snapToGrid),
        ...
        (function() {
            ...
            t.prototype.checkAspectRatio = function(t, e) {
                ...
                var i = t.slice()
                  ...
                  , r = a / n;
                return r < s ? (i[1] = a / s - this.parameters.box.height,
                e && (i[1] = -i[1])) : r > s && (i[0] = this.parameters.box.width - n * s,
                e && (i[0] = -i[0])),
                i
            }
            ,
        ...
        if ("Element"in t) {
            ...
            l.add = function() {
                ...
                do {
                    ...
                    a = !0)
                } while (++i < s);a && this._updateClassName()
            }
            ,
            l.remove = function() {
                ...
                do {
                    ...
                    e = r(this, t); ~e; )
                        ...
                        n = !0,
                        e = r(this, t)
                } while (++s < a);n && this._updateClassName()
            }
            ,
    ...
    function() {
        ...
        var i, s, a = (i = window.requestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame || function(t) {
        ...
        ), n = (s = window.cancelAnimationFrame || window.mozCancelAnimationFrame || window.webkitCancelAnimationFrame || window.clearTimeout,
        function(t) {
            return s(t)
        }
        ...
        window.addResizeListener = function(i, s) {
    ...
    function() {
        ...
        return s(i, [{
            ...
            value: function(t, e) {
                ...
                s.noData && s.collapsedSeries.length !== s.series.length || this.legend.init(),
            ...
            value: function(e) {
                ...
                r.forEach(function(a) {
                    ...
                    s && a.series.getPreviousPaths()),
                    e && "object" === t(e) && (a.config = new k(e),
                    e = w.extendArrayProps(a.config, e),
                    r.config = u.extend(r.config, e),
                    n && (r.globals.lastXAxis = [],
                    r.globals.lastYAxis = [],
            ...
            value: function() {
                ...
                this.eventList.forEach(function(t) {
                    s.addEventListener(t, function(t) {
                        ...
                        "mousemove" === t.type || "touchmove" === t.type ? "function" == typeof e.config.chart.events.mouseMove && e.config.chart.events.mouseMove(t, i, s) : ("mouseup" === t.type && 1 === t.which || "touchend" === t.type) && ("function" == typeof e.config.chart.events.click && e.config.chart.events.click(t, i, s),
                        i.fireEvent("click", [t, i, s]))
                    }, {
                        capture: !1,
                        passive: !0
                    })
            ...
            value: function(t, e) {
                var i = this.w
                  , s = null;
                i.globals.axisCharts ? s = i.globals.dom.Paper.select(".apexcharts-series[data\\:realIndex='".concat(t, "'] path[j='").concat(e, "'], .apexcharts-series[data\\:realIndex='").concat(t, "'] circle[j='").concat(e, "'], .apexcharts-series[data\\:realIndex='").concat(t, "'] rect[j='").concat(e, "']")).members[0] : (s = i.globals.dom.Paper.select(".apexcharts-series[data\\:realIndex='".concat(t, "']")).members[0],
                ("pie" === i.config.chart.type || "donut" === i.config.chart.type) && new Y(this.ctx).pieClicked(t));
                s ? new p(this.ctx).pathMouseDown(s, null) : console.warn("toggleDataPointSelection: Element not found");
